...
#include <mpi.h>
#include <cstring>
#include "compute_temp_dumbbell.h"
#include "atom.h"
#include "neighbor.h"
#include "update.h"
#include "force.h"
...
ComputeTempDumbbell::ComputeTempDumbbell(LAMMPS *lmp, int narg, char **arg) :
...
ComputeTempDumbbell::~ComputeTempDumbbell()
{
  if (!copymode)
    delete [] vector;
}
...
void ComputeTempDumbbell::setup()
{
  dynamic = 0;
...
double ComputeTempDumbbell::compute_scalar()
{
...
void ComputeTempDumbbell::compute_vector()
{
