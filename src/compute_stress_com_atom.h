...
ComputeStyle(stress/com/atom,ComputeStressCOMAtom)

#else

#ifndef LMP_COMPUTE_STRESSCOM_ATOM_H
#define LMP_COMPUTE_STRESSCOM_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeStressCOMAtom : public Compute {
 public:
  ComputeStressCOMAtom(class LAMMPS *, int, char **);
  ~ComputeStressCOMAtom();
  void init();
